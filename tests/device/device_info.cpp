...
TEST_CASE("device info", "[device]") {
...
#if !SYCL_CTS_COMPILING_WITH_HIPSYCL
  {
    ...
    check_get_info_param<sycl::info::device::image_max_buffer_size, size_t>(
        dev);
    // check_get_info_param<sycl::info::device::image_max_array_size,
    // size_t>(dev); TODO REMOVE: not part of the spec
    ...
    // check_get_info_param<sycl::info::device::opencl_c_version, std::string>(dev);  // TODO REMOVE: not part of the spec
